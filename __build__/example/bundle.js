...
var Cropper = exports.Cropper = function (_PIXI$Container) {
    ...
    Cropper.prototype.displayImageHit = function displayImageHit() {
        this.image.displayHit(this.image.isContainsBounds(this.resizeUI) === false);
    };

    Cropper.prototype.displayHit = function displayHit() {
    ...
    Cropper.prototype.startGuide = function startGuide(delayTime) {
        var _this3 = this;
    ...
    Cropper.prototype.stopGuide = function stopGuide() {
    ...
    Cropper.prototype.stopDrawHit = function stopDrawHit() {
        var totalInterval = this.intervalId.length;
    ...
    Cropper.prototype.clearDrawHit = function clearDrawHit() {
    ...
    Cropper.prototype.drawHitAll = function drawHitAll() {
        var _this4 = this;
    ...
    Cropper.prototype.startFixMove = function startFixMove() {
        this.stopFixMove();
    ...
    Cropper.prototype.delayFixMove = function delayFixMove(delayIndex, delayTime) {
        var _this5 = this;
    ...
    Cropper.prototype.stopFixMove = function stopFixMove() {
        var totalInterval = this.intervalId.length;
    ...
    Cropper.prototype.clearFixMove = function clearFixMove() {
        if (this.gTest) this.gTest.clear();
    ...
    Cropper.prototype.doFixMove = function doFixMove(uiPoint, line, delayIndex) {
        var _this6 = this;

        var delayTime = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 3000;
        var displayString = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '';
    ...
    Cropper.prototype.fixMove = function fixMove(uiPoint, line) {
        this.clearFixMove();
    ...
    Cropper.prototype.doDrawHit = function doDrawHit(point, line, delayIndex, delayTime) {
        var _this7 = this;
    ...
    Cropper.prototype.getDelayTime = function getDelayTime(delayIndex) {
        var delayTime = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 3000;

        return delayIndex * delayTime;
    };

    Cropper.prototype.checkHitSide = function checkHitSide() {
    ...
    Cropper.prototype.drawHitSide = function drawHitSide(imageHitSide) {
        var line = void 0;
    ...
    Cropper.prototype.drawHitLine = function drawHitLine(line) {
        var _this8 = this;
    ...
    Cropper.prototype.drawHit = function drawHit(uiPoint, line) {
...
var Resizer = exports.Resizer = function (_PIXI$Container) {
    ...
    Resizer.prototype.initialize = function initialize(canvas, imageElement, textureCanvas) {
        this.paddingX = 216;
        this.paddingY = 158;
        this.canvas = canvas;
        this.imageElement = imageElement;
    ...
    Resizer.prototype.initializeImage = function initializeImage() {
        var size = _Calculator.Calc.getImageSizeKeepAspectRatio(this.image, this.bounds);
        this.image.width = size.width;
        this.image.height = size.height;
        this.image.x = this.canvas.width / 2;
    ...
    Resizer.prototype.test = function test() {}
...
var ImageUI = exports.ImageUI = function (_PIXI$Container) {
    ...
    ImageUI.prototype.displayHit = function displayHit(isHit) {
...
var Calc = exports.Calc = function () {
    ...
    Calc.getRotationPointWithDistance = function getRotationPointWithDistance(pivot, point, angle, distance) {
        var diffX = point.x - pivot.x;
        var diffY = point.y - pivot.y;
        var ca = Math.atan2(diffY, diffX) * 180 / Math.PI;
        var na = (ca + angle) % 360 * Math.PI / 180;
    ...
    Calc.getTriangleCenterPoint = function getTriangleCenterPoint(p0, p1, p2) {
        return {
            x: (p0.x + p1.x + p2.x) / 3,
            y: (p0.y + p1.y + p2.y) / 3
        };
    ...
    Calc.getLineMiddle = function getLineMiddle(p0, p1) {
        return {
            x: (p0.x + p1.x) / 2,
            y: (p0.y + p1.y) / 2
        };
...
var Painter = exports.Painter = function () {
    ...
    Painter.getArrow = function getArrow(startPoint, endPoint) {
