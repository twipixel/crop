...
var _Resizer = require('./resize/Resizer');

var _animation = require('./../../../../src/libs/animation');
...
var ImageEditor = exports.ImageEditor = function () {
    ...
    _createClass(ImageEditor, [{
        key: 'initialize',
        value: function initialize(imageElement, textureCanvas) {
...
},{"./../../../../src/libs/animation":15,"./crop/Cropper":5,"./resize/Resizer":6}],3:[function(require,module,exports){
'use strict';
...
var Cropper = exports.Cropper = function (_PIXI$Container) {
    ...
    _createClass(Cropper, [{
        key: 'initialize',
        value: function initialize(canvas, imageElement, textureCanvas) {
            this.intervalId = [];
            //this.paddingX = 216;
            //this.paddingY = 158;
            this.paddingX = 340;
        ...
        key: 'testNextPosition',
        value: function testNextPosition() {
        ...
        key: 'testPivot',
        value: function testPivot(keycode) {
            var offset;
        ...
        key: 'startGuide',
        value: function startGuide(delayTime) {
            var _this3 = this;
        ...
        value: function drawHitAll() {
            ...
            var uiPoints = [this.resizeUI.lt, this.resizeUI.rt, this.resizeUI.rb, this.resizeUI.lb];

            var imageLines = [this.image.leftLine, this.image.topLine, this.image.rightLine, this.image.bottomLine];

            for (var i = 0; i < uiPoints.length; i++) {
                var point = uiPoints[i];
        ...
        key: 'delayFixMove',
        value: function delayFixMove(delayIndex, delayTime) {
            var _this5 = this;
        ...
        key: 'doFixMove',
        value: function doFixMove(uiPoint, line, delayIndex) {
            var _this6 = this;

            var delayTime = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 3000;
            var fixPoint = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '';
        ...
        key: 'fixMove',
        value: function fixMove(uiPoint, line) {
            this.clearFixMove();

            var space = 0.01;
            var inColor = 0x0D99FC;
            var outColor = 0xEB3333;
            var fixColor = 0xFFFFFF;
            var distancePoint = _Calculator.Calc.getShortestDistancePoint(uiPoint, line.a, line.b);
            var returnPoint = _Calculator.Calc.getReturnPoint(uiPoint, distancePoint);
            var imageX = this.image.x + returnPoint.x;
            var imageY = this.image.y + returnPoint.y;

            this.shortDistancePoint = _Painter.Painter.getCircle(5, outColor);
            this.shortDistancePoint.x = distancePoint.x;
            this.shortDistancePoint.y = distancePoint.y;
            this.returnDirectionArrow = _Painter.Painter.getArrow(this.shortDistancePoint, uiPoint, 10, 1, outColor);
            _Painter.Painter.drawLine(this.gTest, line.a, line.b, 1, outColor);

            this.fixArrow = _Painter.Painter.getArrow(this.image, { x: imageX, y: imageY }, 10, 1, fixColor);
            this.addChild(this.shortDistancePoint);
            this.addChild(this.returnDirectionArrow);
            this.addChild(this.fixArrow);

            var signX = returnPoint.x < 0 ? -1 : 1;
            var signY = returnPoint.y < 0 ? -1 : 1;
        ...
        key: 'doDrawHit',
        value: function doDrawHit(point, line, delayIndex, delayTime) {
            var _this7 = this;

            var id = setTimeout(function () {
                _this7.drawHit(point, line);
            }, this.getDelayTime(delayIndex, delayTime));
        ...
        key: 'getDelayTime',
        value: function getDelayTime(delayIndex) {
            var delayTime = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 3000;

            return delayIndex * delayTime;
        }
    }, {
        key: 'checkHitSide',
        value: function checkHitSide() {
            if (this.hitSide == _HitSide.HitSide.NONE || this.hitSide == void 0) return;
        ...
        key: 'drawHitSide',
        value: function drawHitSide(imageHitSide) {
            var line = void 0;
            ...
            switch (imageHitSide) {
                ...
                case _HitSide.HitSide.RIGHT_TOP:
                case _HitSide.HitSide.RIGHT_BOTTOM:
                ...
                case _HitSide.HitSide.LEFT_TOP:
                case _HitSide.HitSide.LEFT_BOTTOM:
                    line = this.image.leftLine;
                    break;
            }
        ...
        key: 'drawHitLine',
        value: function drawHitLine(line) {
            var _this8 = this;
            ...
            var id = setTimeout(function () {
                _this8.clearDrawHit();
                if (_this8.hitSide.length > 0) _this8.startDrawHit();
            }, this.getDelayTime(drawIndex++, drawTime));
            this.intervalId.push(id);
        }
    }, {
        key: 'drawHit',
        value: function drawHit(uiPoint, line) {
            ...
            var inColor = options.inColor || 0x0D99FC;
            var outColor = options.outColor || 0xEB3333;
            var textColor = options.textColor || 0xFFFFFF;
            var inString = options.inString || '- RIGHT (IN)';
            var outString = options.outString || '+ LEFT (OUT)';

            var triangleArea = _Calculator.Calc.triangleArea(uiPoint, line.a, line.b);

            var color = triangleArea > 0 ? outColor : inColor;
            _Painter.Painter.drawLine(this.gTest, uiPoint, line.a, 1, color);
            _Painter.Painter.drawLine(this.gTest, uiPoint, line.b, 1, color);

            var hitString = triangleArea > 0 ? outString : inString;
            this.text = _Painter.Painter.getText(hitString, textColor, color);
            var textPoint = _Calculator.Calc.getTriangleCenterPoint(uiPoint, line.a, line.b);
            this.text.x = textPoint.x;
            this.text.y = textPoint.y;
            this.directionArrow = _Painter.Painter.getArrow(_Calculator.Calc.getLineMiddle(line.a, line.b), uiPoint);
            this.vectorDirectionArrow = _Painter.Painter.getArrow(line.a, line.b, 10, 1, 0xFFFFFF);
        ...
        key: 'cornerResizeStart',
        value: function cornerResizeStart(e) {
            this.stopGuide();
            this.stopDrawHit();
            this.stopFixMove();
        ...
        key: 'magnifyImage',
        value: function magnifyImage(lens) {
        ...
        key: 'cornerResizeChange',
        value: function cornerResizeChange(e) {
            var changePoint;
            var dx = e.dx;
            var dy = e.dy;
            var corner = e.target;
        ...
        key: 'cornerResizeEnd',
        value: function cornerResizeEnd(e) {
            this.magnifyImage(this.resizeUI.bounds);
            this.moveUI.setSize(this.resizeUI.bounds);
            this.gLens.clear();
        ...
        key: 'displayImageRotationBounds',
         ...
         */
        value: function displayImageRotationBounds() {
...
},{"./../const/HitSide":3,"./../const/KeyCode":4,"./../ui/ImageUI":9,"./../ui/MoveUI":10,"./../ui/ResizeUI":11,"./../ui/RotateUI":12,"./../utils/Calculator":13,"./../utils/Painter":14}],6:[function(require,module,exports){
'use strict';
...
var Resizer = exports.Resizer = function (_PIXI$Container) {
    _inherits(Resizer, _PIXI$Container);

    function Resizer(canvas, imageElement, textureCanvas) {
        _classCallCheck(this, Resizer);

        var _this = _possibleConstructorReturn(this, (Resizer.__proto__ || Object.getPrototypeOf(Resizer)).call(this));
...
},{"./../ui/ImageUI":9,"./../utils/Calculator":13}],7:[function(require,module,exports){
'use strict';
...
var CornerShape = exports.CornerShape = function (_PIXI$Sprite) {
    ...
    function CornerShape(type) {
        ...
        var _this = _possibleConstructorReturn(this, (CornerShape.__proto__ || Object.getPrototypeOf(CornerShape)).call(this));
...
var ImageUI = exports.ImageUI = function (_PIXI$Container) {
    ...
    function ImageUI(textureCanvas) {
        ...
        var _this = _possibleConstructorReturn(this, (ImageUI.__proto__ || Object.getPrototypeOf(ImageUI)).call(this));
    ...
    _createClass(ImageUI, [{
        key: 'initialize',
        value: function initialize(textureCanvas) {
            this.textureCanvas = textureCanvas;
        ...
        key: 'displayHit',
        value: function displayHit(isHit) {
        ...
        key: 'getMoveUpdatePoints',
        value: function getMoveUpdatePoints(dx, dy) {
        ...
        key: 'fixMove',
        value: function fixMove(resizeUI) {
        ...
        key: 'getImageMaxScale',
        value: function getImageMaxScale(bounds) {
        ...
        key: 'updatePrevLtPointForPivot',
        value: function updatePrevLtPointForPivot() {
            this.prevLtX = this.lt.x;
            this.prevLtY = this.lt.y;
        }
    }, {
        key: 'setPivot',
        value: function setPivot(globalPivot) {
        ...
        key: 'isContainsBounds',
        value: function isContainsBounds(bounds) {
        ...
        key: 'getHitSide',
        value: function getHitSide(bounds) {
            var lt = this.lt;
            var rt = this.rt;
            var rb = this.rb;
            var lb = this.lb;
        ...
        key: 'getHitPoints',
        value: function getHitPoints(bounds) {
            var lt = this.lt;
            var rt = this.rt;
            var rb = this.rb;
            var lb = this.lb;
        ...
        key: 'getUpdatePoints',
        value: function getUpdatePoints(dx, dy) {
...
},{"./../const/HitSide":3,"./../utils/Calculator":13,"./../utils/Painter":14}],10:[function(require,module,exports){
'use strict';
...
var MoveUI = exports.MoveUI = function (_PIXI$Sprite) {
    ...
    function MoveUI(canvas) {
        ...
        var _this = _possibleConstructorReturn(this, (MoveUI.__proto__ || Object.getPrototypeOf(MoveUI)).call(this));
    ...
    _createClass(MoveUI, [{
        ...
        key: 'setSize',
        value: function setSize(sizeRect) {
        ...
        key: 'removeMouseDownEvent',
        value: function removeMouseDownEvent() {
...
},{"./../utils/Calculator":13}],11:[function(require,module,exports){
'use strict';
...
var ResizeUI = exports.ResizeUI = function (_PIXI$Container) {
    ...
    function ResizeUI(canvas) {
        ...
        var _this = _possibleConstructorReturn(this, (ResizeUI.__proto__ || Object.getPrototypeOf(ResizeUI)).call(this));
    ...
    _createClass(ResizeUI, [{
        key: 'initialize',
        value: function initialize(canavs) {
            this.offset = -1;
            this.canvas = canvas;
        ...
        key: 'resize',
        value: function resize(imageRect) {
            this.resizeCornerShape(imageRect);
            this.resizeControl();
            this.drawImageRect();
        }
    }, {
        key: 'resizeCornerShape',
        value: function resizeCornerShape(imageRect) {
        ...
        key: 'updateOtherCorner',
        value: function updateOtherCorner(changeCorner) {
            switch (changeCorner) {
                case this.lt:
                    this.rt.y = this.lt.y;
                    this.lb.x = this.lt.x;
        ...
        key: 'setPoint',
        value: function setPoint(points) {
        ...
        key: 'getCornerUpdatePoints',
        value: function getCornerUpdatePoints(corner, tx, ty) {
            var points = this.points;
        ...
        key: 'fixCorner',
        value: function fixCorner(corner, points, image) {
        ...
        key: 'getLeft',
        value: function getLeft(points, image) {
            var ltx, lbx;
        ...
        key: 'getTop',
        value: function getTop(points, image) {
            var lty, rty;
        ...
        key: 'getRight',
        value: function getRight(points, image) {
            var rtx, rbx;
        ...
        key: 'getBottom',
        value: function getBottom(points, image) {
            var rby, lby;
        ...
        key: 'pointsToBounds',
        value: function pointsToBounds(points) {
            return {
                x: points.lt.x,
                y: points.lt.y,
        ...
        key: 'addCornerDownEvent',
        value: function addCornerDownEvent() {
        ...
        key: 'removeCornerDownEvent',
        value: function removeCornerDownEvent() {
        ...
        key: 'addCornerMoveEvent',
        value: function addCornerMoveEvent() {
        ...
        key: 'removeCornerMoveEvent',
        value: function removeCornerMoveEvent() {
...
},{"./../const/HitSide":3,"./../utils/Calculator":13,"./../utils/Painter":14,"./ControlArea":7,"./CornerShape":8}],12:[function(require,module,exports){
'use strict';
...
var RotateUI = exports.RotateUI = function (_PIXI$Sprite) {
    ...
    function RotateUI(canvas) {
        ...
        var _this = _possibleConstructorReturn(this, (RotateUI.__proto__ || Object.getPrototypeOf(RotateUI)).call(this));
...
},{"./../utils/Calculator":13}],13:[function(require,module,exports){
'use strict';
...
var Calc = exports.Calc = function () {
    ...
    _createClass(Calc, null, [{
        key: 'getImageSizeKeepAspectRatio',
         ...
         */
        value: function getImageSizeKeepAspectRatio(imageSize, boundsSize) {
        ...
        key: 'getBoundsScale',
        value: function getBoundsScale(boundsSize, imageSize) {
        ...
        key: 'getRotation',
        value: function getRotation(centerPoint, mousePoint) {
        ...
        key: 'getDiagonal',
        value: function getDiagonal(width, height) {
        ...
        value: function getRectangleWidth(originalWidth, originalHeight, newHeight) {
        ...
        key: 'isInsideSquare',
        value: function isInsideSquare(point, lt, rt, rb, lb) {
            //console.log(
        ...
        key: 'sampleCodeHitTest',
        value: function sampleCodeHitTest(point, lt, rt, rb, lb) {
        ...
        key: 'getPointsByBounds',
        value: function getPointsByBounds(bounds) {
            return {
        ...
        key: 'digit',
        value: function digit(convertNumber) {
        ...
        key: 'getOneToOne',
        value: function getOneToOne(x, a, b, c, d) {
        ...
        value: function getRotationPoint(pivot, point, angle) {
        ...
        key: 'getRotationPointWithDistance',
        value: function getRotationPointWithDistance(pivot, point, angle, distance) {
            var diffX = point.x - pivot.x;
            var diffY = point.y - pivot.y;
            var ca = Math.atan2(diffY, diffX) * 180 / Math.PI;
            var na = (ca + angle) % 360 * Math.PI / 180;
        ...
        key: 'getRotationRectanglePoints',
        value: function getRotationRectanglePoints(pivot, rectanglePoints, angle) {
        ...
        key: 'getBoundsRectangle',
        value: function getBoundsRectangle(rectanglePoints) {
        ...
        key: 'getShortestDistancePoint',
        value: function getShortestDistancePoint(point, linePointA, linePointB) {
        ...
        value: function distToSegmentSquared(point, linePointA, linePointB) {
        ...
        key: 'distToSegment',
        value: function distToSegment(point, linePointA, linePointB) {
        ...
        key: 'getReturnPoint',
        value: function getReturnPoint(point, distancePoint) {
        ...
        key: 'moveToCollision',
        value: function moveToCollision(image, point, line) {
        ...
        key: 'getNextMovePosition',
        value: function getNextMovePosition(centerX, centerY, radius, rotation) {
            //distance *= 0.4;
        ...
        key: 'hasBox',
        value: function hasBox(parent, child) {
        ...
        key: 'getTriangleCenterPoint',
        value: function getTriangleCenterPoint(p0, p1, p2) {
            return {
                x: (p0.x + p1.x + p2.x) / 3,
                y: (p0.y + p1.y + p2.y) / 3
            };
        ...
        key: 'getLineMiddle',
        value: function getLineMiddle(p0, p1) {
            return {
                x: (p0.x + p1.x) / 2,
                y: (p0.y + p1.y) / 2
            };
...
var Painter = exports.Painter = function () {
    ...
    _createClass(Painter, null, [{
        ...
        key: 'drawBounds',
        value: function drawBounds(graphics, bounds) {
        ...
        key: 'drawCircle',
        value: function drawCircle(graphics, point) {
        ...
        key: 'drawGrid',
        value: function drawGrid(graphics, width, height) {
        ...
        key: 'drawDistToSegment',
        value: function drawDistToSegment(graphics, point, lineA, lineB, distancePoint) {
            // 1. 라인 그리기
        ...
        key: 'drawLine',
        value: function drawLine(graphics, p1, p2) {
            var thickness = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
            var color = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0xFF3300;
        ...
        key: 'drawTriagle',
        value: function drawTriagle(graphics, p0, p1, p2) {
        ...
        key: 'getArrow',
        value: function getArrow(startPoint, endPoint) {
            var arrowDistance = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 10;
            var thickness = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
            ...
            var right = _Calculator.Calc.getRotationPointWithDistance(endPoint, startPoint, 45, arrowDistance);
            var left = _Calculator.Calc.getRotationPointWithDistance(endPoint, startPoint, -45, arrowDistance);
...
},{"./Calculator":13}],15:[function(require,module,exports){
"use strict";
